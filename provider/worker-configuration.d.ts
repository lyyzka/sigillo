/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 606c444316e976a86b1ef2dff5d30caa)
// Runtime types generated with workerd@1.20260903.1 2026-04-16 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	BETTER_AUTH_URL: "https://sigillo-provider.yangyangli0426.workers.dev";
	LINGXILOOP_SSO_URL: "https://admin.lingxilearn.cn";
	BETTER_AUTH_SECRET: string;
	LINGXILOOP_SSO_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "LINGXILOOP_SSO_URL" | "BETTER_AUTH_SECRET" | "LINGXILOOP_SSO_SECRET">> {}
}
